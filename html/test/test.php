            ...
            <div class="justify-content-end">
                ...
                <form method="POST" id="langForm" action="">
                    <select name="lang" id="lang" onchange="changeLanguage(this.value)">
                        <option value="fr" <?= (isset($_COOKIE['language']) && $_COOKIE['language'] == 'fr') || (isset($_SESSION['language']) && $_SESSION['language'] == 'fr') ? 'selected' : '' ?>>🇫🇷</option>
                        <option value="en" <?= (isset($_COOKIE['language']) && $_COOKIE['language'] == 'en') || (isset($_SESSION['language']) && $_SESSION['language'] == 'en') ? 'selected' : '' ?>>🇬🇧</option>
                    </select>
                </form>
